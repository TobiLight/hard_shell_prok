...
int shellx_call_args_helper(char **, int, int *);

/**
 * shellx_call_args_helper - Helper function for shellx_call_args
 ...
 */
int shellx_call_args_helper(char **args, int response, int *exec_ret)
{
	int i;
...
int shellx_call_args(char **args, char **beg_arg, int *exec_ret)
{
	...
	shellx_call_args_helper(args, response, exec_ret);
	args = shellx_replace_aliases(args);
	response = shellx_run_args(args, beg_arg, exec_ret);
	return (response);
}
